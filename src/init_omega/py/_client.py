...
from ._exceptions import APIStatusError, InitOmegaPyError
...
class InitOmegaPy(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous InitOmegaPy client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("INIT_OMEGA_PY_BASE_URL")
        if base_url is None:
            base_url = f"https://petstore3.swagger.io/api/v3"

        custom_headers_env = os.environ.get("INIT_OMEGA_PY_CUSTOM_HEADERS")
    ...
    @cached_property
    def with_raw_response(self) -> InitOmegaPyWithRawResponse:
        return InitOmegaPyWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> InitOmegaPyWithStreamedResponse:
        return InitOmegaPyWithStreamedResponse(self)
...
class AsyncInitOmegaPy(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncInitOmegaPy client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncInitOmegaPyWithRawResponse:
        return AsyncInitOmegaPyWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncInitOmegaPyWithStreamedResponse:
        return AsyncInitOmegaPyWithStreamedResponse(self)
...
class InitOmegaPyWithRawResponse:
    _client: InitOmegaPy

    def __init__(self, client: InitOmegaPy) -> None:
        self._client = client
...
class AsyncInitOmegaPyWithRawResponse:
    _client: AsyncInitOmegaPy

    def __init__(self, client: AsyncInitOmegaPy) -> None:
        self._client = client
...
class InitOmegaPyWithStreamedResponse:
    _client: InitOmegaPy
...
class AsyncInitOmegaPyWithStreamedResponse:
    _client: AsyncInitOmegaPy
