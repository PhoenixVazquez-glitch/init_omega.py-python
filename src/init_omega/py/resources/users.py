...
class UsersResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> UsersResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/PhoenixVazquez-glitch/init_omega.py-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> UsersResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/PhoenixVazquez-glitch/init_omega.py-python#with_streaming_response
        """
